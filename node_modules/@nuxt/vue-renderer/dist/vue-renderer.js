/*!
 * @nuxt/vue-renderer v2.4.5 (c) 2016-2019
...
class VueRenderer {
  ...
  loadResources(_fs, isMFS = false) {
    const distPath = path__default.resolve(this.context.options.buildDir, 'dist', 'server');
    const updated = [];
    const { resourceMap } = this;

    const readResource = (fileName, encoding) => {
      try {
        const fullPath = path__default.resolve(distPath, fileName);
